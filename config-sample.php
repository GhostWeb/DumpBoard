...
# HSV colour value. Note: number between 0 & 1 . The higher the number the more colourful the text. The formula is value V ∈ [0, 1]. The default of 0.85 is good for reading on $
$value = '0.85';
